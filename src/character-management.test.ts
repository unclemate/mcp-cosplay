...
describe("Character Management", () => {
  ...
  describe("preset characters", () => {
    it("should initialize with no preset characters", () => {
  ...
  describe("characterToPersonalityConfig", () => {
    ...
    it("should use default intensity when not provided", () => {
      ...
      manager.addCharacter(testChar);
      const config = manager.characterToPersonalityConfig("强度测试");
    ...
    it("should handle custom intensity values", () => {
      const testChar: CharacterProfile = {
        ...
        description: "自定义强度测试",
        personality: {
          signaturePhrases: ["自定义"],
          toneWords: ["自"],
          attitude: "friendly",
          speechPatterns: ["自定义"],
          backgroundContext: "自定义背景",
          emojiPreferences: ["🎛️"],
          languageStyle: "自定义风格",
        },
        category: "测试",
      ...
      manager.addCharacter(testChar);
      const config = manager.characterToPersonalityConfig("自定义强度测试", 5);
